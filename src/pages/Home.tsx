...
const PLACEHOLDER_REELS: Reel[] = [
  { id: '1', title: 'Zirakpur harassment caught on camera', instagram_url: 'https://instagram.com/p/...', video_url: '', embed_code: null, category: 'Women Safety', thumbnail_url: '', views_count: 45000, is_featured: true, created_at: '2025-05-28T10:00:00Z' },
  { id: '2', title: 'Real face of Indian politics', instagram_url: 'https://instagram.com/p/...', video_url: '', embed_code: null, category: 'Politics', thumbnail_url: '', views_count: 32000, is_featured: true, created_at: '2025-05-27T08:00:00Z' },
  { id: '3', title: 'Civic sense fail - Tourist edition', instagram_url: 'https://instagram.com/p/...', video_url: '', embed_code: null, category: 'Ground Reports', thumbnail_url: '', views_count: 28000, is_featured: true, created_at: '2025-05-26T12:00:00Z' },
  { id: '4', title: 'Racism against Indians abroad', instagram_url: 'https://instagram.com/p/...', video_url: '', embed_code: null, category: 'Crime', thumbnail_url: '', views_count: 51000, is_featured: true, created_at: '2025-05-25T15:00:00Z' },
];
          ...
          {loading ? <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">{Array.from({ length: 4 }).map((_, i) => <ReelCardSkeleton key={i} />)}</div> : (
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
              {reels.map((reel, index) => (
                <div key={reel.id} className="group card-glass rounded-xl overflow-hidden animate-fade-in cursor-pointer" style={{ animationDelay: `${index * 0.1}s` }} onClick={() => reel.instagram_url && window.open(reel.instagram_url, '_blank')}>
